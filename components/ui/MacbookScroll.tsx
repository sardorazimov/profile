...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[200vh]  flex flex-col items-center  py-0 my-0 md:flex justify-start flex-shrink-0 [perspective:100px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
